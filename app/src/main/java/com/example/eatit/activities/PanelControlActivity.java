...
import com.example.eatit.fragments.ingredientes.listar.FragmentMisIngredientes;
import com.example.eatit.fragments.recetas.listar.FragmentBuscador;
import com.example.eatit.fragments.recetas.listar.FragmentMisRecetas;
    ...
    private void mostrarOpcion(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.nav_ingredientes3:
                ...
                status = 1;
                fragmentTransaction.setCustomAnimations(android.R.anim.fade_in, android.R.anim.fade_out);
                fragmentTransaction.replace(R.id.frame_inicio, new FragmentMisIngredientes(usuario));
                break;
